...
*** Haskell version
    I do not have much experience with arrays or any mutable states in haskell. I tried with immutable arrays but, got the wrong answer after consuming ~3GB or memory. Somehow both haskell and elisp implementations are wrong. Have I misunderstood the problem somehow?
